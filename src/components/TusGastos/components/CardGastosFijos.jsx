    ...
    <Card className="dark max-w-[720px] h-[320px] mt-2">
      <CardHeader className="flex justify-between items-center">
        ...
        <div className="flex flex-col">
          <span className="text-lg font-bold">Hogar</span>
        </div>

        {/* Contenedor que se alinea a la derecha para el valor total y el DropdownMenu */}
        <div className="flex items-center">
          {/* Este div ocupa el espacio pero está invisible para mantener el espacio de los botones */}
        ...
        {transactions.map((trans, index) => (
          <React.Fragment key={index}>
            <div className="grid grid-cols-6 gap-4 items-center">
              <div className="flex items-center justify-center col-span-1 mr-5">
              ...
              <div className="flex items-center justify-center col-span-1 ml-14">
                <span className="text-base">{trans.interest}</span>
              </div>
              <div className="flex items-center justify-center col-span-1">
                <span className="text-base">{trans.paid}</span>{" "}
              </div>
            </div>
