          ...
          if (gastoVariable && gastoVariable.gastoVariableID) {
            ...
            const fetchGastosVariable = async () => {
              try {
                ...
                if (!response.ok) {
                  throw new Error("No se pudo obtener la información de los gastos variables");
                }
                const data = await response.json();
            ...
            console.log("gastoVariable no definido o falta gastoVariableID:", gastoVariable);
          }
        ...
        <Card className="dark w-[600px] h-[320px] mt-2">
          <CardHeader className="flex justify-between items-center">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm font-bold mr-24 "> {gastoVariable.valorTotal.toLocaleString("es-ES", { maximumFractionDigits: 0 })} </span>
            </div>
