...
function CardGastoVariable({ userId, gastoVariable, CurrentDate }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/gastosvariables/${gastoVariable.gastoVariableID}/gastos`,
        {
          method: "POST",
          headers: {
  ...
  useEffect(() => {
    if (gastoVariable && gastoVariable.gastoVariableID) {
      const apiUrl = `https://finanplusback.zeabur.app/usuarios/${userId}/gastosvariables/${gastoVariable.gastoVariableID}/gastos`;
  ...
  const updateTipoGasto = async (gastoID, nuevoTipo) => {
    try {
      const response = await fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/gastosvariables/${gastoVariable.gastoVariableID}/gastos/${gastoID}/tipo`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  const handlePagoChange = async (gastoID, newVal) => {
    try {
      const response = await fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/gastosvariables/${gastoVariable.gastoVariableID}/gastos/${gastoID}/pagado`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
