...
function ModalEditarBorrarAhorros({ isOpen, onClose, userId, currentDate }) {
  ...
  useEffect(() => {
    if (userId && currentDate) {
      ...
      fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/ahorros/fecha?year=${year}&month=${month}`
      )
  ...
  const handleDeleteAhorro = () => {
    if (ahorroSeleccionado && ahorroSeleccionado.ahorroID) {
      fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/ahorros/${ahorroSeleccionado.ahorroID}`,
        {
          method: "DELETE",
        }
      )
  ...
  const handleEditAhorro = () => {
    if (ahorroSeleccionado && ahorroSeleccionado.ahorroID) {
      const url = `https://finanplusback.zeabur.app/usuarios/${userId}/ahorros/${ahorroSeleccionado.ahorroID}`;
