...
function Resumen() {
  ...
  useEffect(() => {
    if (userId && currentDate) {
      ...
      const url = `https://finanplusback.zeabur.app/usuarios/${userId}/resumenmensual/totales?year=${year}`;
      fetch(url)
  ...
  useEffect(() => {
    if (userId && currentDate) {
      ...
      fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/gastosfijos/fecha?year=${year}`
      )
        .then((response) => response.json())
        .then((data) => {
          setGastosFijos(data);
      ...
      fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/gastosvariables/fecha?year=${year}`
      )
        .then((response) => response.json())
        .then((data) => {
      ...
      fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/gastosdiario/fecha?year=${year}`
      )
        .then((response) => response.json())
        .then((data) => {
      ...
      fetch(
        `https://finanplusback.zeabur.app/usuarios/${userId}/tarjetascredito/fecha?year=${year}`
      )
        .then((response) => response.json())
        .then((data) => {
